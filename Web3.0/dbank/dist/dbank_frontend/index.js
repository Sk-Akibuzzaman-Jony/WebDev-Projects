...
document.querySelector("form").addEventListener("submit", async function(event){
  ...
  if (document.getElementById("input-amount").value.length != 0) {
    await _declarations_dbank_backend__WEBPACK_IMPORTED_MODULE_0__.dbank_backend.topUp(inputText);
  }
  if (document.getElementById("withdrawal-amount").value.length != 0) {
    await _declarations_dbank_backend__WEBPACK_IMPORTED_MODULE_0__.dbank_backend.withdrawl(inputText);
  }
